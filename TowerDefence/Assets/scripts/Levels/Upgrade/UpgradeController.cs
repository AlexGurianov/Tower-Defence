...
public struct TowerAtLevel
{
    ...
    public TowerAtLevel(float d_c, int nUC, string fT, string vT)
    {
        damage_coef = d_c;
        nextUpdateCost = nUC;
        featureText = fT;
...
public class UpgradeController : MonoBehaviour {
	...
	void Awake () {
        towersLevelInfo = new Dictionary<TowerType, List<TowerAtLevel>> {
            { TowerType.tower1, new List<TowerAtLevel> { new TowerAtLevel(1f, 40, "damage", "X 1.2"), new TowerAtLevel(1.2f, 50, "damage", "X 1.3"), new TowerAtLevel(1.2f*1.3f, -1, "", "") } },
            { TowerType.tower2, new List<TowerAtLevel> { new TowerAtLevel(1f, 30, "damage", "X 1.5"), new TowerAtLevel(1.5f, 40, "damage", "X 1.6"), new TowerAtLevel(1.5f*1.6f, -1, "", "") } },
            { TowerType.tower3, new List<TowerAtLevel> { new TowerAtLevel(1f, 20, "damage", "X 2"), new TowerAtLevel(2f, 30, "damage", "X 2.1"), new TowerAtLevel(2f*2.1f, -1, "", "") } }
        };
